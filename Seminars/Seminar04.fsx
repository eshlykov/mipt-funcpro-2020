...
// Замечание: здесь мы говорим о бесконечных списках, как будто они существуют.
// На самом деле стоило бы говорить о ленивых последовательностях seq. Но
// поскольку для них нет встроенного паттерн-матчинга, 

// Правая и левая свертки по-разному работают на бесконечных
// списках. Рассмотрим правую свертку. Первый вопрос, который возникает, - это
...
let factorials = scanLeft ( * ) 1 (Seq.initInfinite (fun i -> i))
