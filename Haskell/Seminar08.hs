...
fiveValid = [undefined] `seq` 5 :: Int
fiveInvalid () = undefined `seq` 5 :: Int
...
oddsTo1  = [11, 9 .. 1] :: [Integer] -- Шаг может быть отрицательным.
...
instance Monoid a => Monoid (Maybe a) where mempty = Just mempty
